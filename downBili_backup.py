...
def get_play_list(aid, cid, quality):
    ...
    headers = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36',
        'Cookie': 'SESSDATA=b6e0a876%2C1740637960%2C7ebba%2A81CjBYoGTRic9yoKUJDiEdFOUZgZSFvHyeljakNadKHb4A9aAsO9jwYcvPi4jApNd6Z8USVkNnSzdwemZjNWhkYW9VZUxjd3lXNFFsZ1BwM00yb0NveUZNbnVEZmRROUZhdWxjV0VtUzRaMnBkdEZVMUJhX0FVdHZ5YnBZV3VWNWJPNzljLUJPeUZRIIEC', # 登录B站后复制一下cookie中的SESSDATA字段,有效期1个月
